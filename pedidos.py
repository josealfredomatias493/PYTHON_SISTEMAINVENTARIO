...
class Application(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.t1=tk.Label(self, text= "Pedidos", font=("Roboto Mono",20,BOLD), bg="white").place(x=433, y=20)
        ...
        self.t4=tk.Label(self, text= "Proveedor:", font=("Roboto Mono",12), bg="white").place(x=249, y=130)
        self.t5=tk.Label(self, text= "Producto:", font=("Roboto Mono",12), bg="white").place(x=256, y=165)
        ...
        self.t10=tk.Label(self, text= "Precio:", font=("Roboto Mono",12), bg="white").place(x=520, y=165)
        ...
        self.ComboBOXProv=ttk.Combobox(value=self.obtenerValoresComboX(),width=18, font=("Roboto Mono",9))
        self.ComboBOXProv.place(x=355,y=135)
        self.ComboBOXProv.bind("<<ComboboxSelected>>", self.obtenerValor)
        self.ComboBOXProvPro=ttk.Combobox(width=18,font=("Roboto Mono",9))
    ...
    def agregarDetalleFact(self,Factura):
        ...
        for child in self.grid1.get_children():
            ...
            self.NoAlmacen=1
            cur.execute(sql,Factura,self.Cantidad,self.CodigoProducto,self.Descripcion,self.NoAlmacen)
        cur.commit()
        cur.close()
